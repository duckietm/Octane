        ...
        <LayoutGridItem shrink alignItems="center" center={false} className="p-1" column={false}>
            <Column className="octane-catalog-marketplace-item-icon">
                <LayoutGridItem
                    ...
                    itemUniqueNumber={offerData.isUniqueLimitedItem ? offerData.stuffData.uniqueNumber : 0}
                />
            </Column>
            <Column grow gap={0}>
                    ...
                    <>
                        <Text>
                            {LocalizeText(
                                ...
                                ['price', 'average'],
                                [offerData.price.toString(), offerData.averagePrice > 0 ? offerData.averagePrice.toString() : '-']
                            )}
                        </Text>
